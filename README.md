...
RDMS is the actual software itself that manages the queries and data.  SQL is the language that's used to interact with and manipulate the software.  

1. Why do tables need a `primary key`?

Tables need a primary key that can uniquely identify that row in the table to be referenced elsewhere.
...
a "order" that can have many "products" and the same "product" will appear in many orders.
